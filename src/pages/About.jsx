        ...
        <div className="row-about">
          ...
          <section>
            <Typography sx={{ mb: 2 }} color="white" variant="h6">
              -Ironhack Full-Stack Web Development Bootcamp Graduate (remote)
            </Typography>
            <Typography sx={{ mb: 2 }} color="white" variant="h6">
            ...
            <Typography sx={{ mb: 2 }} color="white" variant="h6">
              ...
              in Next-JS, Typescript and Vite.
            </Typography>
            <Typography sx={{ mb: 2 }} color="white" variant="h6">
              -2 years of educating future MERN developers where I facilited,
